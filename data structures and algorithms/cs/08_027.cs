...
public class MaximumSubarrayWithTargetSum {
    public static int MaxSubarrayWithTargetSum(int[] nums, int target) {
        var sumIndexMap = new Dictionary<int, int> { { 0, -1 } };
        int maxLength = 0;
        int currentSum = 0;
    ...
    public static void Main(string[] args) {
        ...
        Console.WriteLine("Maximum subarray length: " + result);
    }
}