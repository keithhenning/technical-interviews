...
public class Graph
{
    ...
    public KeyValuePair<Dictionary<string, int>, Dictionary<string, List<string>>> Dijkstra(string start)
    {
        ...
        while (pq.Count > 0)
        {
            ...
            foreach (var edge in graph[currentNode])
            {
                ...
                if (distance < distances[neighbor])
                {
                    ...
                    var newPath = new List<string>(paths[currentNode]) { neighbor };
    ...
    public static void TestDijkstra()
    {
        ...
        if (distances1["Dallas"] != 0) throw new Exception("Test case 1 distances failed");
        if (distances1["Chicago"] != 890) throw new Exception("Test case 1 distances failed");
        if (distances1["Memphis"] != 410) throw new Exception("Test case 1 distances failed");
        if (distances1["Boston"] != 1740) throw new Exception("Test case 1 distances failed");

        // Verify correct paths
        if (!paths1["Dallas"].SequenceEqual(new List<string> { "Dallas" })) throw new Exception("Test case 1 paths failed");
        if (!paths1["Chicago"].SequenceEqual(new List<string> { "Dallas", "Memphis", "Chicago" })) throw new Exception("Test case 1 paths failed");
        if (!paths1["Memphis"].SequenceEqual(new List<string> { "Dallas", "Memphis" })) throw new Exception("Test case 1 paths failed");
        if (!paths1["Boston"].SequenceEqual(new List<string> { "Dallas", "Memphis", "Chicago", "Boston" })) throw new Exception("Test case 1 paths failed");
        ...
        if (distances2["Chicago"] != 920) throw new Exception("Test case 2 reachable distance failed");
        if (distances2["Atlanta"] != int.MaxValue) throw new Exception("Test case 2 unreachable distance failed");
        if (distances2["Miami"] != int.MaxValue) throw new Exception("Test case 2 unreachable distance failed");
        if (paths2.ContainsKey("Atlanta") || paths2.ContainsKey("Miami")) throw new Exception("Test case 2 unreachable paths failed");
        ...
        if (distances3["Dallas"] != 0) throw new Exception("Test case 3 distances failed");
        if (distances3["Chicago"] != 920) throw new Exception("Test case 3 distances failed");
        if (distances3["Atlanta"] != 1510) throw new Exception("Test case 3 distances failed");
        if (distances3["Boston"] != 1770) throw new Exception("Test case 3 distances failed");
        if (!paths3["Boston"].SequenceEqual(new List<string> { "Dallas", "Chicago", "Boston" })) throw new Exception("Test case 3 paths failed");
        ...
        if (distances4["Boston"] != 1770) throw new Exception("Test case 4 distance failed");
        if (!paths4["Boston"].SequenceEqual(new List<string> { "Dallas", "Chicago", "Boston" })) throw new Exception("Test case 4 path failed");
        ...
        if (distances5["Boston"] != 3000000) throw new Exception("Test case 5 large weights failed");
