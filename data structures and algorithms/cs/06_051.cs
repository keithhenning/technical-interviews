...
public class SlidingWindow
{
   ...
   public void TestSlidingWindow()
   {
      ...
      Console.WriteLine(
         "Array: " + string.Join(", ", arr1)
      );
      Console.WriteLine(
         "Expected: 24 (sum of [2, 3, 1, 0])"
      );
      Console.WriteLine(
         "Result: " + MaxSumSubarray(arr1, k1) + "\n"
      );
      ...
      int k2 = 4;
      Console.WriteLine(
         "Test 2: Window equals array size"
      );
      Console.WriteLine(
      ...
      int k3 = 3;
      Console.WriteLine(
         "Test 3: Array smaller than window"
      );
      Console.WriteLine(
         "Array: " + string.Join(", ", arr3)
      );
      Console.WriteLine("Expected: -1");
      Console.WriteLine(
         "Result: " + MaxSumSubarray(arr3, k3) + "\n"
      );
   }
