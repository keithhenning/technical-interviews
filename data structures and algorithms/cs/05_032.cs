...
public class MainClass {
    ...
    public void PetOwnerRelationships() {
        ...
        relationships["Wednesday"] = new List<string> { "Keith" };     
        // Keith is Wednesday's human
        relationships["Keith"] = new List<string> { "Wednesday" };     
        // Whiskers is Tom's cat
        relationships["Whiskers"] = new List<string> { "Tom" };  
        // Tom is Whiskers' human
        relationships["Tom"] = new List<string> { "Whiskers" };  
    }

    public void PrintRelationships(Dictionary<string, List<string>> relationships) {
