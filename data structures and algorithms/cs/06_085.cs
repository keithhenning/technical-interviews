...
public class UnionFind {
    ...
    public static void TestFriendCircles() {
        ...
        for (int i = 0; i < n; i++) {
            Console.WriteLine("Student " + i + " belongs to group " + uf.Find(i));
        }
    }
    ...
    public static void TestNetworkConnectivity() {
        ...
        for (int i = 0; i < n; i++) {
            Console.WriteLine("Computer " + i + " is in component " + uf.Find(i));
        }
    }
    ...
    public static void TestDynamicConnectivity() {
        ...
        int[][] connections = {
            new int[] {0, 1}, new int[] {2, 3}, new int[] {0, 4}, new int[] {3, 4}
        };
        ...
        for (int i = 0; i < connections.Length; i++) {
            ...
            Console.WriteLine("Connected " + x + " and " + y + ": New connection = " + newConnection);
            ...
            for (int j = 0; j < n; j++) {
                for (int k = j + 1; k < n; k++) {
                    Console.WriteLine(j + " and " + k + " connected: " + uf.IsConnected(j, k));
                }
            }
            Console.WriteLine();
        }
