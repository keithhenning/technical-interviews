...
public class RateLimiter {
    ...
    private readonly Dictionary<string, Queue<int>> userMessages;

    public RateLimiter(int messageLimit, int timeWindow) {
        this.messageLimit = messageLimit;
        this.timeWindow = timeWindow;
        this.userMessages = new Dictionary<string, Queue<int>>();
    }
    ...
    public bool CanSend(string userId, int timestamp) {
        ...
        while (messageQueue.Count > 0 && messageQueue.Peek() <= timestamp - timeWindow) {
