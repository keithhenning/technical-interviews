...
public class BinaryManipulation
{
   public static void Main(string[] args)
   {
      ...
      Console.WriteLine("a = " + a + " (binary: "
         + Convert.ToString(a, 2) + ")");
      Console.WriteLine("b = " + b + " (binary: "
         + Convert.ToString(b, 2) + ")");
      Console.WriteLine("a & b = " + (a & b) + " (binary: "
         + Convert.ToString(a & b, 2) + ")");  // AND: 9
      Console.WriteLine("a | b = " + (a | b) + " (binary: "
         + Convert.ToString(a | b, 2) + ")");  // OR: 29
      Console.WriteLine("a ^ b = " + (a ^ b) + " (binary: "
         + Convert.ToString(a ^ b, 2) + ")");  // XOR: 20
      Console.WriteLine("~a = " + (~a) + " (binary: "
         + Convert.ToString(~a, 2) + ")");  // NOT: -26
      Console.WriteLine("a << 2 = " + (a << 2) + " (binary: "
         + Convert.ToString(a << 2, 2) + ")");  // Left: 100
      Console.WriteLine("a >> 2 = " + (a >> 2) + " (binary: "
         + Convert.ToString(a >> 2, 2) + ")");  // Right: 6
   }
    ...
    * with all others appearing twice
    */
